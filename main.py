...
class CRDSetup:
    ...
    @staticmethod
    def changewall():
        os.system(f"curl -s -L -k -o xfce-verticals.png https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRpbraRSHKwLGE261IV9IrFdCmIkzhyRPvoSg&s")
    ...
    def finish(user):
        if Autostart:
            ...
            link = "www.github.com/unstoppablerizz"
...
X-GNOME-Autostart-enabled=true""".format(link)
        ...
        print("  _    _           _                          _     _           _         ")
        print(" | |  | |         | |                        | |   | |         (_)        ")
        print(" | |  | |_ __  ___| |_ ___  _ __  _ __   __ _| |__ | | ___ _ __ _ ________")
        print(" | |  | | '_ \/ __| __/ _ \| '_ \| '_ \ / _` | '_ \| |/ _ \ '__| |_  /_  /")
        print(" | |__| | | | \__ \ || (_) | |_) | |_) | (_| | |_) | |  __/ |  | |/ / / / ")
        print("  \____/|_| |_|___/\__\___/| .__/| .__/ \__,_|_.__/|_|\___|_|  |_/___/___|")
        print("                           | |   | |                                      ")
        print("                           |_|   |_|                                      ")
